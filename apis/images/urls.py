...
urlpatterns = [
    ...
    path('list/trashed', ImagesListTrash.as_view(), name="trashed_images"),
    ...
    path('like', star_image, name="star_image"),
    path('dislike', un_star_image, name="un_star_image"),
    ...
    path('<int:image_id>/download', download_image, name="downlaod image")
]
