...
from .views import AlbumsList, get_album_by_id, get_albums_filter_by_star_status, get_detailed_album, delete_album, \
    update_album_star, update_album_title, update_album_unstar
...
urlpatterns = [
    ...
    path('<int:album_id>/rename/<str:title>', update_album_title, name="rename_album"),
    path('star/<int:star>', get_albums_filter_by_star_status, name="album_start_status"),
]
